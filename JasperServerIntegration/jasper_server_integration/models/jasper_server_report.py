...
class JasperServerReport(models.Model):
    ...
    report_name = fields.Char(string="Nombre del informe", help="El nombre del informe. Aparecerá en la lista de items a imprimir")
    report_path = fields.Char(string="Ruta del informe", help="La localización del informe en Jasper Server.")
